                ...
                <nav className="navbar navbar-default">
                    <div className="container-fluid">
                        ...
                        <ul className="nav navbar-nav">
                            ...
                            {this.state.isUser ? (<li><Link to="/randomNumber">Random Number</Link></li>) : (null)}
                            {this.state.isAdmin ? (<li><Link to="/allUsers">List of Users</Link></li>):(null)}
                            {this.state.isUser ? (<li><Link to="/user">Page for Users </Link></li>) : this.state.isAdmin ?
                                (<li><Link to="/admin">Page for Admins</Link></li>) : (<div></div>)}
                        </ul>
